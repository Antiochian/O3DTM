function varargout = my_los2(Z, R, lat1, lon1, lat2, lon2, ...
...
if numel(lat1) == 1
    ...
    [visprofile, dist, h, lattrk, lontrk, x1, z1, x2, z2] = my_calculateLOS(F, R, ...
    ...
    for i = 1:length(lat1)
        [visprofile{i}, dist{i}, h{i}, lattrk{i}, lontrk{i}, x1, z1, x2, z2] ...
            = my_calculateLOS(F, R, lat1(i), lon1(i), lat2(i), lon2(i), ...
